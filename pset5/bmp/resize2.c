...
int main(int argc, char* argv[])
{
    ...
    int large_padding = (large_bi.biWidth + 4) % 4;
    
    
    // get new sizes
    
    large_bi.biSizeImage = abs(large_bi.biHeight) * (large_bi.biWidth + large_padding) * sizeof(RGBTRIPLE);
    ...
    for (int a = 0; a < old_height; a++)
    {
        ...
        fseek(inptr, 54 + (a * old_width * sizeof(RGBTRIPLE)) + (small_padding * a * sizeof(RGBTRIPLE)), SEEK_SET);
        ...
        fseek(inptr, (small_padding * sizeof(RGBTRIPLE)), SEEK_CUR);
